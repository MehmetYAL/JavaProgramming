...
public class ScrumTeam {
    ...
    public void removeTester(int emloyeeId){
        testersList.removeIf(p-> p.emlpyeeId==emloyeeId);
    }
    public void removeDeveloper(int employeeId){
        developersList.removeIf(p-> p.emlpyeeId==employeeId);
    }
    ...
    public String toString() {
        return "ScrumTeam{" +
                ...
                ", BA='" + BA + '\'' +
                ", SM='" + SM + '\'' +
                ", total number testers=" + testersList.size() +
                ", total number developers=" + developersList.size() +
                ", total daysOfSprint=" + daysOfSprint +
                '}';
    }
}
/*
