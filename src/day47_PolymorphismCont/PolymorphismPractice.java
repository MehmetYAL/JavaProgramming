...
public class PolymorphismPractice {
    public static void main(String[] args) {
        ...
        Car carWithHigestMileage= cars[0];
        Car carWithLowestMileage = cars[0];
        for (Car eachCar : cars) {
            if (eachCar.miles>carWithHigestMileage.miles){
                carWithHigestMileage=eachCar;
            }
        ...
        System.out.println("carWithHigestMileage = " + carWithHigestMileage);
